...
- `PROJECT_AGENTS.md` and `FIRST_PROMPT.md` can use concise agent-facing English section names if that improves Codex execution, but the task details should remain understandable to the user.
